...
## Aerial fire blanket promotion

- Preliminary aircraft payload/coverage/material figures are hypotheses until exact packed configuration, measured mass properties, allowable aircraft floor/ramp/roller/restraint/extraction loads and certified release envelope are approved; brochure maximum payload is not accepted as airdrop evidence.
- Material promotion passes coupon through full-panel tests for areal-density variation, tensile/tear/puncture/abrasion/fold fatigue, permeability/venting, radiant/convective/flame/ember exposure, underside heat transfer, smoke/toxicity, water/retardant, electrical/static/lightning, UV/moisture/freeze-thaw, contamination, cleaning, reuse and disposal.
- Coupled robot/parafoil/tether/membrane models are calibrated against progressively larger tests and cover extraction/opening shock, reefing, vents, aeroelastic/sail behavior, entanglement, collision, tension/breakaway, canopy/robot/panel failure and bounded jettison/emergency footprints.
- Each aircraft/tail/payload revision has an immutable loading and release configuration with loadmaster/aircraft engineering evidence, crew procedures, inspection, telemetry, abort/divert/retention/jettison behavior and ground/flight-test lineage.
- Release requires current matching aircraft and incident/safety decisions plus validated exclusion/surveillance, fire/weather/wind/smoke/terrain/airspace, navigation/time/communications, payload health and ground readiness; either authority can veto and automation cannot compel release.
- Ground transition tests cover landing, tools/traction state, utilities/people/wildlife, anchor compatibility, vent/contact/tension/gap sensing, wind/uplift, thermal/ember exposure, panel isolation, suppression/vegetation ownership and alternate containment.
- Mission closure accounts for every robot, parafoil, tether, reel, panel, joint, anchor, cradle component and chemical load and proves custody, quarantine, recovery, reuse, repair, recycling or approved sacrificial disposition.
- Effectiveness claims state exposure, protected area/time, comparison baseline/counterfactual, uncertainty and limitations; installation or payload fit alone never establishes wildfire effectiveness.
