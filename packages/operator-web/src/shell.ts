...
function workspaceSupplement(context:Workspace):string{
  ...
  if(context==="aerial")return`<section class="experience-panel blanket-control aerial-live-operation"><header><div><span class="kicker">AIR TACTICAL GPS · LIVE CONTAINMENT PLAN</span><h3>Cargo robot release, water-bomber runs & perimeter installation</h3></div><b><i></i> AIRSPACE ACTIVE · 4 AIRCRAFT</b></header><div class="aerial-operation-stage"><svg viewBox="0 0 1000 430" role="img" aria-label="Pilot tactical GPS showing cargo aircraft, water bombers, release routes, water drops, an active wildfire and a robot-installed retardant perimeter"><defs><pattern id="aerial-grid" width="42" height="42" patternUnits="userSpaceOnUse"><path d="M42 0H0V42" fill="none" stroke="#73b49a" stroke-opacity=".08"/></pattern><filter id="fire-glow"><feGaussianBlur stdDeviation="9" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><rect width="1000" height="430" fill="url(#aerial-grid)"/><g class="aerial-terrain"><path d="M-20 100C130 36 228 139 361 78S596 37 736 105 917 102 1030 57"/><path d="M-20 159C128 95 232 195 374 134S606 96 751 159 915 160 1030 117"/><path d="M-20 343C129 280 244 376 388 317S626 281 770 344 926 347 1030 307"/></g><path class="cargo-route route-one" d="M-70 334C147 263 252 129 469 95S796 154 1075 60"/><path class="cargo-route route-two" d="M-80 123C171 173 275 333 501 340S789 228 1080 311"/><path class="water-route" d="M-70 221C172 211 293 204 448 214S720 250 1070 216"/><g class="active-fire-shape"><path d="M434 151C486 116 542 135 561 174 610 157 653 192 637 232 674 267 631 305 590 291 557 331 494 310 483 278 438 287 404 251 420 219 390 191 403 165 434 151Z"/><text x="523" y="222">ACTIVE FIRE</text></g><path class="water-drop-zone" d="M414 190C462 170 543 179 596 213"/><path class="blanket-laid" d="M384 137C455 82 563 79 641 136M670 169C708 226 697 296 646 345M610 367C524 407 426 379 369 319"/><path class="blanket-installing" d="M344 285C317 232 324 181 355 151"/><g class="release-gate" transform="translate(337 150)"><circle r="19"/><text x="-24" y="-27">ROBOT RELEASE</text></g><g class="release-gate water-gate" transform="translate(407 210)"><circle r="19"/><text x="-24" y="34">WATER GATE</text></g><g class="ground-robots"><circle cx="360" cy="301" r="4"/><circle cx="379" cy="323" r="4"/><circle cx="407" cy="348" r="4"/><circle cx="449" cy="370" r="4"/><circle cx="501" cy="380" r="4"/><circle cx="557" cy="375" r="4"/><circle cx="608" cy="356" r="4"/></g><g class="gps-waypoints"><circle cx="190" cy="185" r="5"/><text x="199" y="181">WP-2</text><circle cx="337" cy="150" r="5"/><text x="346" y="146">RG-A</text><circle cx="710" cy="144" r="5"/><text x="719" y="140">EXIT</text></g></svg><div class="cargo-plane plane-one"><i>✈</i><b>CARGO-07</b><span>9 robots · FL042</span></div><div class="cargo-plane plane-two"><i>✈</i><b>CARGO-12</b><span>Run 05 complete</span></div><div class="cargo-plane water-plane"><i>✈</i><b>WATER-21</b><span>6,200 L · DROP ARMED</span></div><div class="robot-drop drop-one"><i>◆</i><i>◆</i><i>◆</i><i>◆</i></div><div class="robot-drop drop-two"><i>◆</i><i>◆</i><i>◆</i></div><div class="water-drop-stream"><i></i><i></i><i></i><i></i><i></i></div><div class="pilot-heading"><span>240</span><span>250</span><b>260°</b><span>270</span><span>280</span><i></i></div><div class="pilot-flight-data left"><span><small>IAS</small><b>148</b><em>KT</em></span><span><small>ALT</small><b>4,240</b><em>FT</em></span><span><small>VS</small><b>-120</b><em>FPM</em></span></div><div class="pilot-flight-data right"><span><small>WP RG-A</small><b>2.8</b><em>NM</em></span><span><small>TIME TO DROP</small><b>00:42</b><em>ARMED</em></span><span><small>WIND</small><b>028/18</b><em>KT</em></span></div><div class="aerial-operation-hud"><span><small>ROBOT RUN 06</small><b>67% released</b></span><span><small>WATER-21</small><b>6,200 L armed</b></span><span><small>PERIMETER</small><b>74% secured</b></span><span><small>NEXT PASS</small><b>01:42</b></span></div><div class="aerial-activity-feed"><b>LIVE AIR ACTIVITY</b><span><time>NOW</time>WATER-21 inbound to Drop Zone W-3</span><span><time>-06s</time>CARGO-07 released Cohort D</span><span><time>-14s</time>WATER-18 drop complete · 5,800 L</span><span><time>-21s</time>Perimeter segment P-14 secured</span></div><div class="aerial-scene-legend"><span><i class="laid"></i>Barrier secured</span><span><i class="installing"></i>Installing</span><span><i class="water"></i>Water drop</span><span><i class="route"></i>GPS route</span></div></div><div class="blanket-field compact-blanket-field">${Array.from({length:48},(_,i)=>`<i class="${i===16?"fault":i<38?"anchored":"airborne"}" title="Panel ${String(i+1).padStart(2,"0")}"></i>`).join("")}</div><footer><span>ROBOTS ANCHORED <b>38</b></span><span>WATER AIRCRAFT <b>2 active</b></span><span>WATER DELIVERED <b>11,600 L</b></span><span>PERIMETER SECURED <b>74%</b></span></footer></section>`;
  if(context==="vehicle")return`<section class="experience-panel brain-control"><header><div><span class="kicker">CONTINENTAL VEHICLE INTEGRATION</span><h3>Gateway sessions, protocol adapters & command outcomes</h3></div><b><i></i> 2.4M SESSIONS ONLINE</b></header><div class="workspace-fire-map" data-vehicle-fire-map></div><div class="vehicle-link-metrics"><span><small>COMMAND ACK</small><b>99.97%</b></span><span><small>MEDIAN LATENCY</small><b>18 ms</b></span><span><small>TELEMETRY RATE</small><b>8.4 TB/s</b></span><span><small>ISOLATED COHORTS</small><b>3</b></span></div><div class="integration-console"><section><div class="integration-heading"><span><small>PROTOCOL ADAPTERS</small><b>5 / 5 healthy</b></span><em>Normalized envelope v7</em></div><div class="adapter-grid"><article><i class="adapter-ok"></i><b>ROS 2 / DDS</b><span>1.08M sessions</span><small>12 ms · nominal</small></article><article><i class="adapter-ok"></i><b>MQTT 5</b><span>742K sessions</span><small>19 ms · nominal</small></article><article><i class="adapter-ok"></i><b>CAN-FD</b><span>318K sessions</span><small>8 ms · nominal</small></article><article class="adapter-watch"><i></i><b>MAVLink 2</b><span>195K sessions</span><small>31 ms · 3 cohorts isolated</small></article><article><i class="adapter-ok"></i><b>OPC UA</b><span>65K sessions</span><small>22 ms · nominal</small></article></div></section><section class="intent-pipeline"><div class="integration-heading"><span><small>COMMAND VI-CMD-8821</small><b>Execution acknowledged</b></span><em>idem-7cc…91a</em></div><div class="intent-stages"><span class="done"><i>✓</i><b>Signed</b><small>0 ms</small></span><span class="done"><i>✓</i><b>Routed</b><small>7 ms</small></span><span class="done"><i>✓</i><b>Accepted</b><small>18 ms</small></span><span class="active"><i>↻</i><b>Executing</b><small>4.2 s</small></span><span><i>5</i><b>Outcome</b><small>pending</small></span></div><dl><div><dt>Target</dt><dd>R-017 · water relay</dd></div><div><dt>Version fence</dt><dd>2048 / 77</dd></div><div><dt>Duplicate guard</dt><dd class="good-text">Armed</dd></div><div><dt>Clock quality</dt><dd>±8 ms</dd></div></dl></section></div></section>`;
...
function legacyMapMarkup(): string {
  ...
  <div class="map-canvas">
    <svg viewBox="0 0 1000 620" role="img" aria-label="Topographic map showing the Ridge Creek fire perimeter and deployed assets">
      <defs><pattern id="grid" width="52" height="52" patternUnits="userSpaceOnUse"><path d="M52 0H0V52" fill="none" stroke="rgba(255,255,255,.035)"/></pattern><filter id="glow"><feGaussianBlur stdDeviation="8" result="blur"/><feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>
      <rect width="1000" height="620" fill="url(#grid)"/><g class="contours" fill="none"><path d="M-30 130C150 50 225 195 390 113S705 20 1040 116"/><path d="M-40 190C145 103 247 255 430 171S769 78 1040 168"/><path d="M-20 430C139 350 250 464 421 398S745 324 1040 403"/><path d="M-20 500C197 416 296 552 507 468S813 423 1040 485"/></g>
      <path class="road" d="M-20 533C176 502 259 394 424 416S652 559 1020 505"/><path class="road minor" d="M680-20C652 119 769 223 711 356S675 524 738 650"/>
      <path class="exclusion" d="M318 135L614 103 800 260 740 462 474 505 261 363Z"/>
      <path class="fire-halo" d="M395 196C464 153 546 170 582 221C629 208 702 242 691 301C737 343 689 404 626 397C594 446 509 436 478 398C418 424 352 377 374 322C323 279 349 220 395 196Z"/>
      <path class="fire" d="M407 211C472 171 527 194 559 238C612 219 667 250 652 299C701 334 655 382 605 374C569 419 514 408 486 375C429 398 385 360 405 316C361 278 374 234 407 211Z"/>
      <path class="blanket" d="M477 239L607 227 628 327 493 350Z"/><path class="mission-line" d="M146 465C272 425 357 332 483 287"/>
      <g class="asset asset-air" transform="translate(148 464)"><circle r="17"/><path d="M-10 0L0-6 13 0 0 4Z"/></g><g class="asset" transform="translate(370 432)"><circle r="14"/><text y="5">R7</text></g><g class="asset" transform="translate(726 210)"><circle r="14"/><text y="5">R4</text></g><g class="asset station" transform="translate(826 454)"><rect x="-15" y="-15" width="30" height="30" rx="5"/><text y="5">S2</text></g>
      <g class="map-label"><text x="426" y="176">RIDGE CREEK FIRE</text><text x="503" y="303">BLANKET ZONE A</text><text x="90" y="510">AIR-12 · INBOUND</text><text x="760" y="495">STATION BRAVO</text></g>
    </svg>
...
function hazardVisualMarkup(): string {
  return `<div class="workspace-fire-map hazard-live-map" data-hazard-intelligence-map role="application" aria-label="Interactive Canada and United States wildfire hazard intelligence map"></div>`;
}
...
function domainWorkspaces(): string {
  ...
  <section class="domain-view" id="domain-station" hidden><div class="view-title"><div><span class="kicker">STATION OPERATIONS</span><h2>National habitat & edge operations</h2><p>High-level readiness across microgrids, charging, thermal safety, inventory, communications, and local edge continuity.</p></div><button class="domain-action">Optimize network</button></div><div class="domain-metrics station-metrics"><article><small>HABITATS ONLINE</small><strong>11 / 12</strong><span>1 islanded · locally safe</span></article><article><small>AVAILABLE POWER</small><strong>2.84 MW</strong><span>18.6 MWh stored</span></article><article><small>CHARGING NOW</small><strong>428</strong><span>62 queued · 91% SLA</span></article><article><small>EDGE CURRENT</small><strong>11 / 12</strong><span class="warn-text">HB-07 sync delayed</span></article></div><div class="station-operations-grid"><section class="data-panel station-network"><div class="panel-title"><div><span class="kicker">ALL STATIONS</span><h3>Operational readiness</h3></div><span class="station-network-summary"><i></i>10 available · 1 islanded · 1 service</span></div><div class="station-table"><div class="station-row station-head"><span>Station / region</span><span>Mode</span><span>Energy</span><span>Charging</span><span>Edge / link</span><span>Readiness</span></div><div class="station-row selected"><span><b>Bravo · HB-02</b><small>Prince George, BC</small></span><span>Grid + island</span><span><b>78%</b><small>318 kW bus</small></span><span>48 active<small>12 queued</small></span><span>12 ms<small>cursor current</small></span><span><em class="station-state available">Available</em></span></div><div class="station-row"><span><b>Alpha · HB-01</b><small>Kamloops, BC</small></span><span>Grid tied</span><span><b>84%</b><small>276 kW bus</small></span><span>64 active<small>8 queued</small></span><span>15 ms<small>cursor current</small></span><span><em class="station-state available">Available</em></span></div><div class="station-row"><span><b>Ontario North · HB-06</b><small>Sioux Lookout, ON</small></span><span>Islanded</span><span><b>71%</b><small>44 h autonomy</small></span><span>39 active<small>16 queued</small></span><span>Store/forward<small>uplink degraded</small></span><span><em class="station-state islanded">Islanded</em></span></div><div class="station-row"><span><b>Prairie · HB-04</b><small>La Ronge, SK</small></span><span>Grid + solar</span><span><b>88%</b><small>241 kW bus</small></span><span>52 active<small>4 queued</small></span><span>18 ms<small>cursor current</small></span><span><em class="station-state available">Available</em></span></div><div class="station-row"><span><b>Great Lakes · HB-07</b><small>Thunder Bay, ON</small></span><span>Grid tied</span><span><b>66%</b><small>thermal reserve</small></span><span>31 active<small>9 queued</small></span><span class="warn-text">4m stale<small>reconciling</small></span><span><em class="station-state service">Service</em></span></div><div class="station-row"><span><b>Atlantic · HB-09</b><small>Fredericton, NB</small></span><span>Grid + storage</span><span><b>81%</b><small>198 kW bus</small></span><span>27 active<small>3 queued</small></span><span>21 ms<small>cursor current</small></span><span><em class="station-state available">Available</em></span></div></div></section><aside class="station-rail"><section class="data-panel"><span class="kicker">NETWORK ENERGY</span><h3>Generation & critical load</h3><div class="station-energy-stack"><span><small>PV / WIND / HYDRO</small><b>1.62 MW</b><i style="--station-bar:72%"></i></span><span><small>GRID IMPORT</small><b>1.08 MW</b><i style="--station-bar:48%"></i></span><span><small>CRITICAL LOAD</small><b>1.94 MW</b><i class="load" style="--station-bar:86%"></i></span><span><small>CHARGING LOAD</small><b>0.76 MW</b><i class="charge" style="--station-bar:34%"></i></span></div><p class="station-reserve">Emergency departure reserve protected at all 12 habitats.</p></section><section class="data-panel station-exceptions"><span class="kicker">EXCEPTIONS</span><h3>Requires coordination</h3><article><i>!</i><div><b>HB-07 edge sync delayed</b><span>Reconciliation active · commands remain local</span></div></article><article><i>△</i><div><b>HB-06 satellite uplink degraded</b><span>Store-and-forward queue · 18.4 MB</span></div></article><article><i>°</i><div><b>BAT-882 thermal isolation</b><span>Bravo Zone C · quarantine verified</span></div></article></section></aside><section class="data-panel station-selected"><div><span class="table-state ok">SELECTED · AVAILABLE</span><h3>Station Bravo · Habitat HB-02</h3><p>Edge deployment 3.12.4 · policy bundle 88 · sync cursor 194,220</p></div><div class="energy-flow"><div><small>PV ARRAY</small><strong>142 kW</strong></div><i>→</i><div><small>MICROGRID BUS</small><strong>318 kW</strong></div><i>→</i><div><small>CRITICAL LOAD</small><strong>96 kW</strong></div></div><div class="station-selected-facts"><span><small>ROBOT CAPACITY</small><b>1,240</b></span><span><small>ACTIVE CHARGERS</small><b>48 / 64</b></span><span><small>WINTER AUTONOMY</small><b>38 h</b></span><span><small>PODS READY</small><b>18 / 20</b></span><span><small>MAINTENANCE BAYS</small><b>7 / 9 free</b></span><span><small>FIRE SYSTEM</small><b class="good-text">Armed</b></span></div></section></div></section>
  <section class="domain-view" id="domain-logistics" hidden><div class="view-title"><div><span class="kicker">LOGISTICS</span><h2>Supply, custody & mobilization</h2><p>Reservations, routes, deliveries, water lineage, pods, carriers, and useful arrival.</p></div><button class="domain-action">Create supply plan</button></div><div class="domain-metrics"><article><small>WATER RESERVED</small><strong>42,000 L</strong><span>3 verified sources</span></article><article><small>IN TRANSIT</small><strong>6</strong><span>Custody current</span></article><article><small>SHORTAGES</small><strong>2</strong><span class="warn-text">Filters · tether kits</span></article><article><small>USEFUL ARRIVAL</small><strong>94%</strong><span>Within incident SLA</span></article></div><div class="split-view"><section class="data-panel"><h3>Delivery flow</h3><div class="delivery-timeline"><article class="done"><b>DL-771</b><span>Water · 18,000 L</span><small>Delivered · quantity reconciled</small></article><article class="moving"><b>DL-778</b><span>Anchor kits · 48</span><small>Checkpoint 3/5 · custody Fleet-Carrier-08</small></article><article class="held"><b>DL-781</b><span>Battery modules · 12</span><small>Held · Route L-04 closure</small></article></div></section><section class="data-panel"><h3>Mass mobilization wave</h3><div class="wave"><b>WAVE MW-22</b><span>Origin habitats</span><i></i><span>3 carriers / 6 pods</span><i></i><span>Station Bravo</span></div><dl><div><dt>Robots sealed</dt><dd>96 / 96</dd></div><div><dt>Downstream slots</dt><dd>96 reserved</dd></div><div><dt>CG / securement</dt><dd class="good-text">Verified</dd></div><div><dt>ETA distribution</dt><dd>42–51 min</dd></div></dl></section></div></section>
...
export function renderOperatorShell(
  ...
  const weatherPanel = `<section class="panel weather incident-weather"><div class="section-heading"><div><span class="kicker">FIELD CONDITIONS</span><h2>Weather window</h2></div><span class="weather-icon">☀</span></div><div class="weather-main"><strong>31°</strong><div><b>Dry & gusting</b><span>Feels like 33°</span></div></div><div class="weather-grid"><span><small>WIND</small><b>18 km/h ↗</b></span><span><small>HUMIDITY</small><b>21%</b></span><span><small>VISIBILITY</small><b>6.4 km</b></span><span><small>FIRE INDEX</small><b class="danger">Extreme</b></span></div></section>`;
  const liveCommandsPanel = `<section class="command-bar incident-live-commands"><div><span class="live-dot"></span><strong>Live commands</strong><span>Acceptance, execution, and physical outcome are independently verified.</span></div><ol class="commands">${snapshot.commands.map((c) => `<li><span>${escape(c.stage)}</span><strong>${escape(c.detail)}</strong><time datetime="${escape(c.updatedAt)}">${new Date(c.updatedAt).toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit" })}</time></li>`).join("") || "<li><strong>No commands in progress</strong></li>"}</ol></section>`;
  root.innerHTML = `<div class="app-shell">
    ...
    <section class="context-drawer" aria-label="Detailed operational context">${contexts
      ...
      .join("")}</section>
    </main></div></div><div class="sr-only" role="status" aria-live="polite" id="announcer"></div>`;
  root
